...
export class News extends Component {
    ...
    constructor(){
      ...
      async componentDidMount(){
        let url =`https://newsapi.org/v2/top-headlines?country=in&apiKey=138d24878ea34cbcacbf18eeb714ac2c&page=1&pageSize=${this.props.pageSize}`;
       ...
       handlePrevClick = async ()=>{
         ...
         let url =`https://newsapi.org/v2/top-headlines?country=in&apiKey=138d24878ea34cbcacbf18eeb714ac2c&page=${ this.state.page - 1}&pageSize=${this.props.pageSize}`;
         this.setState({loading: true});
         let data = await fetch(url);
         let parsedData = await data.json()
         console.log(parsedData);
